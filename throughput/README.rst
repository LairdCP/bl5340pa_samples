...
#. Reset both kits.
#. Type ``central`` in the terminal connected to the first kit to set it into the central (tester) role.
#. Optionally select advertisement PHY type. Coded s=2 cannot be used for advertisements.
#. Type ``peripheral`` in the terminal connected to the second kit to set it into the peripheral (peer) role.
...
For the tester::
   ...
   *** Booting Zephyr OS build v3.0.99-ncs1  ***
   ...
   Type "central" on the central board.
   Type "peripheral" on the peripheral board.
   uart:~$
